...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <?php if($pendingEvents->isNotEmpty()): ?>
    <section class="mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-orange-50/30 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="font-bold text-gray-900"><?php echo e($event->event_name); ?></div>
                            <div class="text-[10px] text-gray-400 truncate max-w-xs"><?php echo e($event->needs); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-semibold text-gray-700"><?php echo e($event->start_date->format('d M Y')); ?></div>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <a href="<?php echo e(route('admin.event-requests.index')); ?>" class="inline-flex items-center gap-1 text-orange-600 hover:text-orange-800 font-bold text-xs uppercase tracking-wider transition">
                                Kelola Event
