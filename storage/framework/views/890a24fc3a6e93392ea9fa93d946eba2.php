<?php $__env->startSection('title', 'Tambah Mobil Damkar | Damkar Dispatch'); ?>
            ...
            <div>
                ...
                <select name="type" required
                    ...
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type->name); ?>" <?php echo e(old('type') == $type->name ? 'selected' : ''); ?>>
                            <?php echo e($type->name); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($types->isEmpty()): ?>
                        <option value="BASIC" <?php echo e(old('type') == 'BASIC' ? 'selected' : ''); ?>>BASIC</option>
                        <option value="Jenazah" <?php echo e(old('type') == 'Jenazah' ? 'selected' : ''); ?>>Jenazah</option>
                    <?php endif; ?>
                </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/Dev/damkar-dispatch/resources/views/admin/ambulances/create.blade.php ENDPATH**/ ?>