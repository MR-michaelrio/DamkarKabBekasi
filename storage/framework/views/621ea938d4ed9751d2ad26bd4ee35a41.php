            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="<?php echo e(route('portal.jadwal')); ?>" 
                   ...
                   style="animation-delay: 0.4s">
                    ...
                    <p class="text-sm text-gray-500 mb-6">Lihat jadwal penggunaan unit damkar lapangan.</p>
                    <div class="inline-flex items-center text-red-600 font-semibold">
                        Buka Jadwal →
                    </div>
                </a>
...
<?php /**PATH /Applications/Dev/damkar-dispatch/resources/views/auth/portal.blade.php ENDPATH**/ ?>