...
<body class="bg-gradient-to-br from-slate-50 via-white to-slate-100 min-h-screen text-gray-800 flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center p-6">
        <div class="max-w-4xl w-full">
            ...
            <div class="text-center mb-12 fade-up">
                <img src="<?php echo e(asset('logo-damkar.png')); ?>" alt="Damkar Logo" class="h-16 mx-auto mb-4">
    ...
    <footer class="py-8 text-center text-xs text-gray-400">
        © <?php echo e(date('Y')); ?> Dinas Pemadam Kebakaran dan Penyelamatan Kabupaten Bekasi.
    </footer>
...
</html><?php /**PATH /Applications/Dev/damkar-dispatch/resources/views/auth/portal.blade.php ENDPATH**/ ?>