...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('admin.patient-requests.edit', $patientRequest->id)); ?>" 
            ...
            <a href="<?php echo e(route('admin.patient-requests.pdf', $patientRequest->id)); ?>" 
    ...
    <div class="bg-white shadow rounded-xl p-6 space-y-6 border border-gray-100">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 border-t border-gray-50 pt-6">
            ...
            <div>
                ...
                <p class="text-lg font-bold text-gray-900 mt-1">
                    <?php if($patientRequest->patient_condition === 'kebakaran'): ?> 🔥 <?php elseif($patientRequest->patient_condition === 'rescue'): ?> 🚒 <?php endif; ?>
