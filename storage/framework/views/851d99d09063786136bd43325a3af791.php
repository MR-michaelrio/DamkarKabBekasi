...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <nav class="flex mb-5" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm text-gray-500">
            <li>
                <a href="<?php echo e(route('admin.ambulances.index')); ?>" class="hover:text-blue-600">Armada</a>
            </li>
            <li>
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e($maintenance->maintenance_date->format('d M Y')); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e(number_format($maintenance->odometer, 0, ',', '.')); ?>
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            ...
                            <form action="<?php echo e(route('admin.maintenance.destroy', $maintenance)); ?>" method="POST"
                                class="inline">
                                <?php echo csrf_field(); ?>
...
<div id="addMaintenanceModal"
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form action="<?php echo e(route('admin.ambulances.maintenance.store', $ambulance)); ?>" method="POST"
            class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/Dev/damkar-dispatch/resources/views/admin/ambulances/maintenance/index.blade.php ENDPATH**/ ?>