<?php $__env->startSection('title', 'Tambah Tipe Armada | Damkar Dispatch'); ?>
        ...
        <form action="<?php echo e(route('admin.ambulance-types.store')); ?>" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" required
                       placeholder="Contoh: Fire Truck, Rescue Vehicle, Water Supply"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/Dev/damkar-dispatch/resources/views/admin/ambulance_types/create.blade.php ENDPATH**/ ?>