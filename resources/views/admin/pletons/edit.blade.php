...
@section('title', 'Edit Pleton | Damkar Dispatch')
...
<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('admin.pletons.update', $pleton) }}" method="POST"
        ...
        <div>
            ...
            <input name="name" placeholder="Contoh: Pleton 1" value="{{ old('name', $pleton->name) }}"
