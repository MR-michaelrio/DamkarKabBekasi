...
<head>
    ...
    <title>Bantuan Damkar | Damkar Kabupaten Bekasi</title>
...
<body class="bg-slate-50 min-h-screen text-slate-900">
    ...
    <div class="max-w-2xl mx-auto px-6 py-12">
        <div class="text-center mb-10">
            <img src="{{ asset('logo-damkar.png') }}" alt="Damkar Logo" class="h-12 mx-auto mb-4">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/60 p-8 md:p-10 border border-slate-100">
            <form id="event-form" action="{{ route('portal.event-request.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="cursor-pointer">
                            ...
                            <div
                                class="flex items-center gap-2 p-3 rounded-2xl bg-slate-50 border-2 border-slate-100 peer-checked:border-emerald-500 peer-checked:bg-emerald-50 font-bold text-sm transition-all text-slate-700">
                        ...
                        <label class="cursor-pointer">
                            ...
                            <div
                                class="flex items-center gap-2 p-3 rounded-2xl bg-slate-50 border-2 border-slate-100 peer-checked:border-orange-500 peer-checked:bg-orange-50 font-bold text-sm transition-all text-slate-700">
                ...
                <div class="space-y-2">
                    <label class="text-xs font-black uppercase tracking-widest text-slate-400">Nama Kegiatan / Lokasi
                        Kejadian</label>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="needs" rows="4" required
                        class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 focus:ring-2 focus:ring-emerald-500 font-bold text-slate-800 placeholder:text-slate-300 transition-all"
                        placeholder="Hubungi kami terkait detail personil, unit armada, atau peralatan yang dibutuhkan."></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-black uppercase tracking-widest text-slate-400">Tanggal
                            Selesai</label>
                ...
                <div class="pt-6">
                    ...
                    <a href="{{ route('portal') }}"
                        class="block text-center mt-6 text-slate-400 font-bold hover:text-slate-600 transition-colors">
                        ← Kembali ke Portal
                    </a>
                </div>
            </form>
        ...
        <footer class="mt-12 text-center text-slate-400 text-xs font-bold uppercase tracking-widest">
            © {{ date('Y') }} Damkar Kabupaten Bekasi
        </footer>
    </div>
